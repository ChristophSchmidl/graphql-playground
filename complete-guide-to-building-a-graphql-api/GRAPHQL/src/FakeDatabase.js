class FakeDatabase {
	...
	constructor() {
		this.authors = [
			{ id: '88d6bec2', name: 'Christoph Schmidl', email: 'christoph@awesomecompany.com' },
			{ id: '77e2448a', name: 'Emma Löfgren', email: 'emma@awesomecompany.com' },
			{ id: '0beb564c', name: 'Mila Hendrikse', email: 'mila@awesomecompany.com '}
		];
